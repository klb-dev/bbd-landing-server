...
export const sendEmail = async (data: any) => {
  ...
  let mailOptions;
    ...
    if (budget === '<5k') formattedBudget = 'Less than $5,000';
    if (budget === '5-10k') formattedBudget = '$5,000 - $10,000';
    if (budget === '10-25k') formattedBudget = '$10,000 - $25,000';
    if (budget === '25k+') formattedBudget = '$25,000+';
    if (budget === 'not-sure') formattedBudget = 'Not sure yet';

    // Format timeframe for display
    let formattedTimeframe = timeframe || 'Not specified';
    if (timeframe === 'asap') formattedTimeframe = 'As soon as possible';
    if (timeframe === '1-3months') formattedTimeframe = '1-3 months';
    if (timeframe === '3-6months') formattedTimeframe = '3-6 months';
    if (timeframe === '6months+') formattedTimeframe = '6+ months';
    if (timeframe === 'flexible') formattedTimeframe = 'Flexible';
